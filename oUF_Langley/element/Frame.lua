...
B1_art:SetVertexColor(unpack(ns.Tex.Color.RGB.Orange))
B1_art:SetAlpha(0)
...
B2_art:SetVertexColor(unpack(ns.Tex.Color.RGB.Orange))
B2_art:SetAlpha(0)
...
for i = 1,4 do
	...
	impression[i]:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
