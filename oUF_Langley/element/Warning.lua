...
Warn.HP = function(f)
	...
	XXV_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
	...
	Dead_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
	...
	Ghost_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
...
Warn.Player = function(f)
	...
	Resting_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
	...
	Combat_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
...
Warn.Target = function(f)
	...
	Tapped_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
	...
	Offline_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
	...
	Type_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
