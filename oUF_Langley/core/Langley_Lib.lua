...
ns.Lib.gen_hpbar = function(f, unit, min, max)
	...
	if f.mystyle == "player" then
		...
		--s.Filling:SetVertexColor(unpack(ns.Tex.Color.RGB.Red))
		...
		s.Filling_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.Red))
		...
		impression:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
		...
		Border1:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
		...
		Border2:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
	...
	elseif f.mystyle == "pet" then
		...
		s.Filling:SetPoint("BOTTOMLEFT", s, "BOTTOMLEFT", 0, 0)
		s.Filling:SetVertexColor(unpack(ns.Tex.Color.RGB.Orange))
		...
		s.Filling_Bg:SetPoint("BOTTOMLEFT", s, "BOTTOMLEFT", 0, 0)
		s.Filling_Bg:SetVertexColor(unpack(ns.Tex.Color.RGB.Orange))
		s.Filling_Bg:SetAlpha(0.25)
		s.Filling_Bg:SetSize(128,16)
	...
	elseif f.mystyle == "focus" then
		...
		bg:SetVertexColor(unpack(ns.Tex.Color.RGB.Blue))
		...
		h2:SetBackdropBorderColor(ns.Tex.Color.RGB.BgColor[1], ns.Tex.Color.RGB.BgColor[2], ns.Tex.Color.RGB.BgColor[3], 0.6)
		--]]
		-->Filling<--
		s.Filling = s:CreateTexture(nil, "ARTWORK")
		s.Filling:SetTexture(ns.Tex.Bar.BarHP_Screen)
...
ns.Lib.Focus_Target_Tag = function(f)
	...
	arrow:SetSize(16,16)
	arrow:SetVertexColor(unpack(ns.Tex.Color.RGB.Red))
	arrow:SetAlpha(1)
	...
	arrow_bg:SetVertexColor(ns.Tex.Color.RGB.BgColor[1], ns.Tex.Color.RGB.BgColor[2], ns.Tex.Color.RGB.BgColor[3], 0.6)
	arrow_bg:SetAlpha(1)
