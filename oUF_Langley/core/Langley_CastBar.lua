...
ns.Lib.gen_castbar = function(f)  
		...
		if ticknum and ticknum > 0 then
			...
			for k = 1, ticknum do
				if not ticks[k] then
					...
					ticks[k]:SetVertexColor(ns.Tex.Color.RGB.BgColor[1], ns.Tex.Color.RGB.BgColor[2], ns.Tex.Color.RGB.BgColor[3],0.6)
					ticks[k]:SetWidth(2)
	...
	if f.mystyle == "player" then
		...
		h4:SetBackdropBorderColor(ns.Tex.Color.RGB.BgColor[1], ns.Tex.Color.RGB.BgColor[2], ns.Tex.Color.RGB.BgColor[3], 0.6)
		...
		left:SetSize(16,32)
		left:SetVertexColor(unpack(ns.Tex.Color.RGB.Orange))
		...
		left_bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
		...
		right:SetSize(16,32)
		right:SetVertexColor(unpack(ns.Tex.Color.RGB.Orange))
		...
		right_bg:SetVertexColor(unpack(ns.Tex.Color.RGB.BgColor))
		...
		castbar_bg:SetVertexColor(unpack(ns.Tex.Color.RGB.Blue))
